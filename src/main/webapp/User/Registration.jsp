    ...
    <c:import url="/header.jsp"></c:import>
          ...
          <div class="container">
            ...
            <form method="post" action="${pageContext.request.contextPath}/AddUserToDB">
                ...
                <input type="number" placeholder="Enter Phone Number" name="phoneno" class="form-control"><br>
          ...
          <c:if test="${not empty success}">
              ...
              <p>Click here to Login...  <a  class="btn btn-primary"href="http://localhost:9082/EcomProj/User/Login.jsp">Login</a></p>
